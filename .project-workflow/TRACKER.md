...
| TASK-003 | Configurable ID Namespaces | Complete | `tasks/TASK-003-Configurable-Id-Namespaces/IMPLEMENTATION.md` |
...
| EPIC-018 | Cross-Host Bounded Execution And Release Control | To Do | `tasks/EPIC-018-Cross-Host-Bounded-Execution-And-Release-Control/REQUIREMENTS.md` |
