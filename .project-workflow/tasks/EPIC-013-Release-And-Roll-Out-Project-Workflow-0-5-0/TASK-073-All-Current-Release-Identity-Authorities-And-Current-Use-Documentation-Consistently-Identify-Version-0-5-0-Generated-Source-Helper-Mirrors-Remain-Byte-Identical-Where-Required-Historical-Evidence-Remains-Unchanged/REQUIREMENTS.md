...
Prepare one internally consistent Project Workflow 0.5.0 release identity without altering historical evidence.
...
- Update every current release authority and current-use pin to 0.5.0, add accurate capability-aware Delegate release notes, and preserve required mirror parity.

## Acceptance Criteria (Verifiable)

- AC1: Covers parent AC1 when source version, managed manifest, CLI mirrors, CI/release workflow, changelog, and current-use docs agree on 0.5.0 and historical evidence is unchanged.
...
- Use semantic version 0.5.0 because the accepted Delegate executor/lifecycle expansion is backward-compatible new functionality.
