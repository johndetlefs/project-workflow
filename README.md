...
- Update durable conventions, prompts, skills, agent files, or `AGENTS.md` when the task exposed a repeatable gap
...
│       ├── project-task/
│       ├── project-scaffold/          # legacy alias for project-task
│       ├── project-epic/
