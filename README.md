...
```bash
uvx --from project-workflow==0.5.0 project init --agent codex
```

Choose the mode that matches your agent:

```bash
uvx --from project-workflow==0.5.0 project init --agent github-copilot
uvx --from project-workflow==0.5.0 project init --agent claude-code
uvx --from project-workflow==0.5.0 project init --agent codex
uvx --from project-workflow==0.5.0 project init --agent cursor
```
...
```bash
uvx --from project-workflow==0.5.0 \
